...
PA_OFFSET = +15.49082    #Use the Sky_mot_PA from Horizons of the object for reference and anchoring
# EX: C/2025 R2 (SWAN): -22.877234, C/2025 N1 3I/ATLAS: +15.49082, C/2024 E1: -17.73533, C/2025 A6: +5.23173, C/2022 E3: +18.4369?? 
...
def scale_arrow(dx, dy, ax, frac=0.25):
    """
...
sun_dx_r, sun_dy_r = scale_arrow(sun_dx_r, sun_dy_r, ax, frac=0.25)
...
vel_dx_r, vel_dy_r = scale_arrow(vel_dx_r, vel_dy_r, ax, frac=0.25)
...
# Comet nucleus
# -------------------------------------------------
ax.scatter(0, 0, color="red", s=30, zorder=10, label="Nucleus")
